...
- [x] PDF本文を8pt、画像をページ幅の最大75%へ変更する
- [x] 文字切れと画像分断を避けて改ページし、Sourceを最終ページのフッターへ配置する
- [x] 診断用Release APKで8pt本文の10ページPDFを実機確認する
- [x] 選択PDF保存ボタンを画面下部へ固定し、スクロール追従を実機確認する
- [x] 修正版 `3 (1.0.2)` を内部テストへ公開する
